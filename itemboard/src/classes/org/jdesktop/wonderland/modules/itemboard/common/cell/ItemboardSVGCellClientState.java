...
public class ItemboardSVGCellClientState extends App2DCellClientState
{
  ...
  private static final Logger logger = Logger.getLogger(ItemboardSVGCellClientState.class.getName());
  ...
  public ItemboardSVGCellClientState()
  {
    this(null);
  }

  public ItemboardSVGCellClientState(Vector2f pixelScale)
  {
    super(pixelScale);
  }
  ...
  public void copyLocal(ItemboardSVGCellClientState state)
  {
  ...
  {
    return super.toString() + " [ItemboardSVGCellClientState]: "
      + "position = " + position
