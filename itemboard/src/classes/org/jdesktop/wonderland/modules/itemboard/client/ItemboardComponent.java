...
/**
 * The client side of the communication component that provides communication
...
public class ItemboardComponent extends CellComponent
{
  ...
  private static Logger logger = Logger.getLogger(ItemboardComponent.class.getName());
  /**
   ...
   */
  public ItemboardComponent(Cell cell)
  {
    super(cell);
    this.cell = (ItemboardCell) cell;
...
//        }
  ...
  protected void setStatus(CellStatus status, boolean increasing)
  {
    switch (status)
    {
          ...
          if (msgReceiver == null)
          {
            msgReceiver = new ChannelComponent.ComponentMessageReceiver()
            {
              ...
              public void messageReceived(CellMessage message)
              {
                ...
                ItemboardCellMessage msg = (ItemboardCellMessage) message;
      ...
      case DISK:
        if (msgReceiver != null)
        {
          channelComp.removeMessageReceiver(ItemboardCellMessage.class);
          msgReceiver = null;
        }
        channelComp = null;
        break;
   ...
   */
  public void sendMessage(ItemboardCellMessage msg)
  {
