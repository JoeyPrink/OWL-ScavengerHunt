 ...
 * @author jordanslott
 */
public class ItemboardClientUtils {

    public static final SAXSVGDocumentFactory factory = new SAXSVGDocumentFactory(XMLResourceDescriptor.getXMLParserClassName());
    private static final Logger logger = Logger.getLogger(ItemboardClientUtils.class.getName());
    ...
    public static Document openDocument(String uri) {
        ...
        ItemboardClientUtils.annotateURI(assetURI);
