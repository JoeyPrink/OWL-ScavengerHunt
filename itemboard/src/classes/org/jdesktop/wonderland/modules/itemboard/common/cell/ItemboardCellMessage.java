 ...
 * @author jbarratt
 */
public class ItemboardCellMessage extends CellMessage {

    private static final Logger logger =
            Logger.getLogger(ItemboardCellMessage.class.getName());
    ...
    public ItemboardCellMessage() {
    }

    public ItemboardCellMessage(BigInteger clientID, CellID cellID, String uid, Action action, String xmlString,
    ...
    public ItemboardCellMessage(ItemboardCellMessage pcm) {
